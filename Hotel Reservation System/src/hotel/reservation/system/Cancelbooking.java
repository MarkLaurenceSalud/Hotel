...
public class Cancelbooking extends JFrame implements ActionListener{
    ...
    bCancelP.setBounds(560, 440,300, 50);
    ...
    bCancelB.setBounds(560, 340,300, 50);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if(e.getSource()==bCheckin){
         ...
         mp.setVisible(true);
              ...
              System.out.println("Enter Personal Data id to delete:");
              int id = Integer.parseInt(scanner.nextLine());
              String sql = "DELETE FROM personaldata where id = "+ id;
